...
unsigned int frequency0 = 100; //must be float for divison to work
unsigned int frequency1 = 100; //must be float for divison to work
bool dual_stim = false;
            ...
            if(readString.substring(0,1) == "f"){
                ...
                if (readString[1] = ' '){
                    ...
                    while (readString[i]){
                        ...
                        if ((readString[i] == ' ') or (readString[i] == '')){
                            tmp_int = readString.substring(i_0, i).toInt();
                            i_0 = i;
                        
                            if (value == 0){
                                frequency0 = tmp_int;
                                Serial.print("#frequency0 set:\t");Serial.println(frequency0);
                                dual_stim = false;
                                }
                                ...
                                value = 1;
                                frequency1 = tmp_int;
                                Serial.print("#frequency1 set:\t");Serial.println(frequency1);
                                dual_stim = true;
                            }
                        }
                    }    
                    ...
                    frequency = readString.substring(1).toInt();
